...
function SalesTrendChart({ data }) {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Tendencia de Ventas" }) }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(LineChart, { data, children: [
      ...
      /* @__PURE__ */ jsx(Legend, {}),
      /* @__PURE__ */ jsx(Line, { type: "monotone", dataKey: "ventas", stroke: "var(--primary)", strokeWidth: 2, name: "Ventas ($)" })
    ] }) }) })
  ] });
}
export {
