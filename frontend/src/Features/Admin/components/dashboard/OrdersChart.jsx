...
function OrdersChart({ data }) {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Pedidos por Mes" }) }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(BarChart, { data, children: [
      ...
      /* @__PURE__ */ jsx(Legend, {}),
      /* @__PURE__ */ jsx(Bar, { dataKey: "pedidos", fill: "var(--primary)", radius: [8, 8, 0, 0], name: "Pedidos" })
    ] }) }) })
  ] });
}
export {
