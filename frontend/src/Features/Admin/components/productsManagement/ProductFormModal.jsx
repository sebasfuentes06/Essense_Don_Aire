...
import { validateProductForm } from "../../validations/formValidation";
...
function ProductFormModal({
  ...
  const errors = validateProductForm({ nombre, sku, categoriaValue, proveedorValue, precio, stock, stockMinimo });
  const validate = () => {
    const nextErrors = validateProductForm({ nombre, sku, categoriaValue, proveedorValue, precio, stock, stockMinimo });
